...
export default function UsersIndex() {
    ...
    const fetchDataUsers = async () => {
        //get token from cookies inside the function to ensure its up to date
                                            ...
                                            users.map((user, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-center">
                                                        <Link to={`/admin/users/edit/${user.id}`} className="btn btn-sm btn-primary rounded-sm shadow border-0">Edit</Link>&nbsp;
