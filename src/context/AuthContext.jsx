//import rect dan hooks createContext, useState dan useEffect dari 'react'
...
export const AuthProvider = ({ children }) => {
    //menggunakan use state untuk menyimpan status otentikasi berdasarkan token di cookies
    const [isAuthenticated, setIsAuthenticated] = useState(!!Cookies.get('token'));

    //Menggunakan useEffect untuk mantau perubahan pada token di cookies
    useEffect(() => {
    ...
    //mengembalikan provider dengan nilai isAuthenticated dan serIsAuthenticated yang diperoleh dari useState
    return (
